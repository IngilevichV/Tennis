package bg.proxiad.courses.web.entities.support;
...
public class WeekTimetable implements Serializable {
    ...
    public boolean isOpenOn(LocalDateTime dateTime) {
        ...
        switch (weekday) {
            case MONDAY:
                return isOpenOn(monday, moment);
            case TUESDAY:
                return isOpenOn(tuesday, moment);
            case WEDNESDAY:
                return isOpenOn(wednesday, moment);
            case THURSDAY:
                return isOpenOn(thursday, moment);
            case FRIDAY:
                return isOpenOn(friday, moment);
            case SATURDAY:
                return isOpenOn(saturday, moment);
            case SUNDAY:
                return isOpenOn(sunday, moment);
        }
